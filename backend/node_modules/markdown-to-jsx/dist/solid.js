...
`,"\f","\v"]);function l1($,Z,Y,G,X){var V=[],K=[],U=[],J=Z,Q=Z,O=X.disableAutoLink||G.inAnchor,A=!1,z=!!G.inAnchor,q=!!X.disableParsingRawHTML,W=X.optimizeForStreaming,_=-1,H=-1,D=[],F=function(f0,X1){if(W&&G.inHTML)return!1;if(!z&&(!X1||!X.disableAutoLink)){var b0=f$($,J,G,X,"<");if(b0)return j(J),V.push(b0),J=b0.endPos,Q=J,!0}if(q)return!1;var n1=v$($,J,G,X);if(n1){j(J);var a9=V.length;if(V.push(n1),D)D.push(a9);return J=n1.endPos,Q=J,!0}if(W&&H===-1){if(J+1<Y){var Z0=b($,J+1);if(Z0>=m1&&Z0<=h1||Z0>=a1&&Z0<=r1||Z0===$9||Z0===F9)H=J}}if(!f0)return!1;var G0=o1($,J);if(!G0)return!1;var E1=J+(G0.isClosing?2:1);if(E1>=$.length||j1($[E1]))return!1;var v1=$.indexOf(">",J+1);if(v1!==-1){var G1=J+1,b9=v1-G1;if(b9>=7){var n=c($,"http://",G1);if(n||c($,"https://",G1)){for(var S0=G1;S0<v1;S0++)if(j1($[S0]))return!1}}}var y0=b($,E1);if(Q9(y0)&&E1+1<$.length&&$[E1+1]===":")return!1;if(G0.isClosing&&G0.attrs.trim().length)return!1;if(G0.attrs.length){var U0=!1,u="";for(var _0=0;_0<G0.attrs.length;_0++){var n0=G0.attrs[_0];if(U0&&n0===u)U0=!1;else if(!U0&&(n0==='"'||n0==="'"))U0=!0,u=n0;else if(n0==="*"||n0==="#"||n0==="!"){var E0=_0+1;while(E0<G0.attrs.length&&G0.attrs[E0]!=="="&&G0.attrs[E0]!==" "&&G0.attrs[E0]!=="\t")E0++;if(E0<G0.attrs.length&&G0.attrs[E0]==="=")return!1}}}var J0=$.slice(J,G0.endPos),A1=G0.tagName.toLowerCase(),m=J0,C0=m.indexOf(">");if(C0!==-1){m=m.slice(C0+1);var R0="</"+A1+">",O0=m.indexOf(R0);if(O0!==-1)m=m.slice(0,O0)}var A0=[];if(m.trim()&&X){var d0={...G,inline:!1,inHTML:!0},L0=m.trim();if(O$.test(L0)||W$.test(L0)||F$.test(L0))A0=i9(L0,d0,X);else if(L0)d0.inline=!0,A0=l1(L0,0,L0.length,d0,X)}var i0=G0.whitespaceBeforeAttrs+G0.attrs,D0=u1(i0,A1,G0.tagName,X),Y1={type:M.htmlBlock,tag:G0.tagName,attrs:D0,children:A0,rawText:J0,text:m,verbatim:!0,endPos:G0.endPos};return j(J),V.push(Y1),J=Y1.endPos,Q=J,!0},j=function(f0){if(f0>Q){var X1=$.slice(Q,f0);V.push({type:M.text,text:A?M9(X1):X1}),Q=f0,A=!1}};while(J<Y){var v=b($,J),S=v6(v,O);if(S===0){if(v===P9)A=!0;J++;while(J<Y){if(v=b($,J),v>=J1)break;if(v===P9)A=!0;var w=g9[v];if(w!==0){if(O&&w===1&&(v===i1||v===c1||v===x1)){J++;continue}break}J++}continue}if(v===t0){var E=J,T=0;while(J+T<Y){if(b($,J+T)!==t0)break;T++}if(T>0){var N=J+T,y=-1,B=N;while(B<Y){while(B<Y&&b($,B)!==t0)B++;if(B>=Y)break;var R=0;while(B+R<Y&&b($,B+R)===t0)R++;if(R>T)R=T;var f=B+R;if(R===T&&(B<=N||b($,B-1)!==t0)&&(f>=Y||b($,f)!==t0)){y=B,B=f;break}B++}if(y!==-1){var x=$.slice(N,y),P=!1;for(var g=0;g<x.length;g++){var h=b(x,g);if(h===d||h===V0){P=!0;break}}var L=x;if(P)L=x.replace(/\r\n/g," ").replace(/\r/g," ").replace(/\n/g," ");if(L.length>0){var a=b(L,0),i=b(L,L.length-1);if(a===C&&i===C){for(var j0=1;j0<L.length-1;j0++)if(b(L,j0)!==C){L=L.slice(1,L.length-1);break}}}j(E),V.push({type:M.codeInline,text:L}),J=B,Q=J;continue}if(W&&_===-1){_=E,j(E),Y=E;break}J=N;continue}}if(!z&&!O&&(v===i1||v===c1||v===x1)){var w0=null,z0=J+1<Y?b($,J+1):0,T0=J+2<Y?b($,J+2):0,p=J+3<Y?b($,J+3):0,V1=J+4<Y?b($,J+4):0,X0=J+5<Y?b($,J+5):0;if(v===c1&&z0===s9&&T0===s9&&p===N$)w0="h";else if(v===x1&&z0===x1&&T0===x1&&p===f9)w0="w";else if(v===i1&&z0===s9&&T0===N$&&p===I9&&V1===$9&&X0===$9)w0="f";if(w0){var P0=f$($,J,G,X,w0);if(P0){j(J),V.push(P0),J=P0.endPos,Q=J;continue}}}if(!z&&!O&&v===x9){var M0=f$($,J,G,X,"@");if(M0&&"emailStart"in M0){var{emailStart:Q0,endPos:a0}=M0,I0=[];for(var f=K.length-1;f>=0;f--){var k0=K[f];if(k0.sourcePos>=Q0&&k0.sourcePos<a0){if(k0.nodeIndex>=0&&k0.nodeIndex<V.length)V.splice(k0.nodeIndex,1),I0.push(k0.nodeIndex);K.splice(f,1)}}if(Q0<Q){for(var B=V.length-1;B>=0;B--)if(V[B].type===M.text){V.splice(B,1),I0.push(B);break}Q=Q0}if(I0.length){I0.sort(function(f0,X1){return f0-X1});var B1=0;for(var r=0;r<K.length;r++){var k0=K[r];while(B1<I0.length&&I0[B1]<k0.nodeIndex)B1++;k0.nodeIndex-=B1}}j(Q0),V.push(M0),J=a0,Q=J;continue}}if(v===j9){if(F(!0,!1))continue}if(v===k1){if(J+1<Y&&b($,J+1)===d){var K0=J+2;while(K0<Y&&b($,K0)===C)K0++;if(K0>=Y){J++;continue}j(J),V.push({type:M.breakLine}),J+=2;while(J<Y&&b($,J)===C)J++;Q=J;continue}var B0=J+1<Y?$[J+1]:"";if(B0&&"!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~".indexOf(B0)!==-1){j(J),V.push({type:M.text,text:B0==="&"?"&​":B0}),J+=2,Q=J;continue}}if(v===g1){if(!z){if(J+1<Y&&$[J+1]==="^"){var m0=J+2;while(m0<Y&&$[m0]!=="]")m0++;if(m0<Y){var H0=$.slice(J+2,m0);j(J),V.push({type:M.footnoteReference,target:`#${X.slugify(H0)}`,text:H0}),J=m0+1,Q=J;continue}}if(G.inList&&J+2<Y&&b($,J+2)===H9){var q0=b($,J+1);if(q0===C||q0===b$||q0===y$){j(J),V.push({type:M.gfmTask,completed:q0===b$||q0===y$}),J+=3,Q=J;continue}}}var e=!1;if(J>Z&&$[J-1]==="!"){var l0=0;for(var Y0=J-2;Y0>=Z&&$[Y0]==="\\";Y0--)l0++;if((l0&1)===0){if(e=!0,Q<J-1)j(J-1);if(V.length>0&&V[V.length-1].type===M.text){var $0=V[V.length-1];if($0.text.endsWith("!")){if($0.text=$0.text.slice(0,-1),!$0.text)V.pop()}}}}if(!e)j(J);if(Q=J+1,!z||e)U.push({type:e?"image":"link",pos:e?J-1:J,resultIdx:V.length,inAnchor:z});J++;continue}if(v===H9&&U.length>0){var s=U[U.length-1],r0=s.pos+(s.type==="image"?2:1),$1=J;j(J);var U1=J+1,F1=t$(V,s),Q1=s.type==="link"&&CZ(F1),N1=!1;if(!Q1&&U1<Y&&$[U1]==="("){var F0=k6($,U1+1,!0);if(F0){NZ(V,K,U,s,r0,$1,X.sanitizer(z$(F0.target),"a","href"),F0.title?z$(F0.title):void 0),J=F0.endPos,Q=J;continue}}var s0=G.refs||{};$$(s0);var O1=null,P1=J;if(U1<Y&&$[U1]==="["){var z1=U1+1,B=z1;while(B<Y&&$[B]!=="]")B++;if(B<Y)O1=$.slice(z1,B),P1=B,N1=!0}if(!N1||O1==="")O1=$.slice(r0,$1);var h0=mZ(O1);if(!Q1&&s0&&s0[h0]){var _1=s0[h0];NZ(V,K,U,s,r0,$1,_1.target,_1.title),J=P1+1,Q=J;continue}var b1=s.resultIdx;if(U.pop(),V.length=b1,W){if(V.push(...F1),U1<Y&&$[U1]==="(")return V}else{if(s.type==="image")V.push({type:M.text,text:"!"});V.push({type:M.text,text:"["},...F1,{type:M.text,text:"]"})}for(var g=0;g<K.length;g++)if(K[g].nodeIndex>=b1)K[g].nodeIndex++;J++,Q=J;continue}if(v===E9||v===e1||v===t1||v===d1){var W1=$[J],o=J,Z1=A9($,J,W1);if((W1==="~"||W1==="=")&&Z1!==2){J++;continue}var q1=o+Z1,o0=wZ($,o,q1,Y,0),z9=wZ($,o,q1,Z,1),y1=o0,R1=z9;if(W1==="_"&&o0&&z9){if(o>0){var _9=$[o-1],N9=b(_9);y1=D$(N9,_9)}if(q1<Y){var q9=$[q1],M1=b(q9);R1=D$(M1,q9)}}j(o),K.push({nodeIndex:V.length,type:W1,length:Z1,canOpen:y1,canClose:R1,active:!0,sourcePos:o,inAnchor:z}),V.push({type:M.text,text:$.slice(o,o+Z1)}),J=o+Z1,Q=J;continue}if(v===d){var Y0=J-1,I1=0;while(Y0>=Q&&b($,Y0)===C)I1++,Y0--;if(I1>=2){var K0=J+1;while(K0<Y&&b($,K0)===C)K0++;if(K0>=Y){j(Y0+1),J=Y,Q=Y;continue}j(Y0+1),V.push({type:M.breakLine}),J++;while(J<Y&&b($,J)===C)J++;Q=J;continue}var L1=J>Q?b($,J-1):0,q0=J+1<Y?b($,J+1):0,T1=J>Q&&L1===C&&q0===C?J-1:J;if(j(T1),V.push({type:M.text,text:`
`}),Q=J+1,J>Z&&L1===C&&Q<Y&&b($,Q)===C)Q++;J=Q;continue}if(v===P9)A=!0;J++;while(J<Y){var v=b($,J);if(v>=J1)break;if(v===P9)A=!0;var w=g9[v];if(w===0){J++;continue}if(w===1&&(v===i1||v===c1||v===x1)&&O){J++;continue}break}}if(j(J),K.length)aZ(V,K,null);if(W){var v0=V.length;for(var N0=D.length-1;N0>=0;N0--){var p0=D[N0];if(p0<V.length&&V[p0].type===M.htmlBlock){var S1=V[p0];if(!K9(S1.tag)&&(!S1.children||S1.children.length===0)){if(V.splice(p0,1),p0<v0)v0--;for(var g=0;g<K.length;g++)if(K[g].nodeIndex>p0)K[g].nodeIndex--;for(var g=N0+1;g<D.length;g++)if(D[g]>p0)D[g]--}}}if(_!==-1&&_<v0){for(var u0=V.length-1;u0>=0;u0--)if(V[u0].type===M.text){v0=u0;break}}if(H!==-1&&H<v0){for(var u0=V.length-1;u0>=0;u0--)if(V[u0].type===M.text){v0=u0;break}}for(var B=K.length-1;B>=0;B--)if(K[B].active&&K[B].nodeIndex<v0){if(V.splice(K[B].nodeIndex,1),K[B].nodeIndex<v0)v0--;for(var f=0;f<B;f++)if(K[f].nodeIndex>K[B].nodeIndex)K[f].nodeIndex--}if(v0<V.length)V.length=v0;return V}if(U.length){U.sort(function(f0,X1){return f0.resultIdx-X1.resultIdx});for(var B=0;B<U.length;B++)V.splice(U[B].resultIdx+B,0,{type:M.text,text:U[B].type==="image"?"![":"["})}return V}function f6($,Z,Y,G,X){var V=!1;for(var K=0;K<Z.length;K++)if(Z[K].sourcePos>=G&&Z[K].sourcePos<X){V=!0;break}if(!V)return;var U=t$($,Y),J=[];for(var K=0;K<Z.length;K++){var Q=Z[K];if(Q.sourcePos>=G&&Q.sourcePos<X)J.push({nodeIndex:Q.nodeIndex-Y.resultIdx,type:Q.type,length:Q.length,canOpen:Q.canOpen,canClose:Q.canClose,active:Q.active,sourcePos:Q.sourcePos,inAnchor:Q.inAnchor})}aZ(U,J,null),$.length=Y.resultIdx;for(var O=0;O<U.length;O++)$.push(U[O]);var A=[];for(var K=0;K<Z.length;K++)if(Z[K].sourcePos<G||Z[K].sourcePos>=X)A.push(Z[K]);Z.length=0;for(var O=0;O<A.length;O++)Z.push(A[O])}function g6($,Z,Y,G){if($.type==="link")return{type:M.link,target:Y,title:G,children:Z};return{type:M.image,target:Y||"",alt:c$(Z),title:G}}function t$($,Z){return $.slice(Z.resultIdx)}function NZ($,Z,Y,G,X,V,K,U){f6($,Z,G,X,V);var J=t$($,G);Y.pop(),$.length=G.resultIdx,$.push(g6(G,J,K,U))}function C6($,Z,Y){let G=g0($,Z),X=G<$.length&&$[G]==="<";if(X)G++;let V=G;if(X&&G<$.length&&$[G]===">")return{target:"",endPos:G+1,hadSpace:!1};let K,U;var J=!1;if(X){U=G;while(U<$.length&&$[U]!==">"){let A=$[U];if(A===`
...
`&&$[Q]!=="\r")Q--;Q++;while(Q<U){if($[Q]==="\t")J=J+4-J%4;else J++;Q++}let O=RZ($,U,K,J),A=k($,K);if(A>=$.length){if(!O.trim())return null;return{type:M.codeBlock,text:O,endPos:A}}var z=[];z.push(O);let q=A;while(q<$.length){let _=I($,q);if(w1($,q,_)){let H=_+1;if(H<$.length){let D=I($,H),F=t($,H,D),j=$[H+F.charCount];if(j&&j!==`
`&&(F.spaceEquivalent<4||j===">"&&F.spaceEquivalent<V))break}z.push(`
`)}else{if(t($,q,_).spaceEquivalent<4)break;let D=RZ($,q,_,0);z.push(`
`),z.push(D)}q=k($,_)}let W=z.join("");if(W=W.replace(R6,""),!W.trim())return null;return{type:M.codeBlock,text:W,endPos:q}}function $Z($,Z,Y,G){let X=$[Z];if(X!=="`"&&X!=="~")return null;let V=A9($,Z,X);if(V<3)return null;let K=Z;while(K>0&&b($,K-1)!==d)K--;let U=t($,K,Z),J=U.spaceEquivalent,Q=J;if(J===4&&U.charCount===4)J=0,Q=4;if(J>=4)return null;let O=g0($,Z+V),A=I($,O),z=$.slice(O,A).trim();if(X==="`"&&z.indexOf("`")!==-1)return null;z=z.replace(p$,"$1");let q=z.indexOf(" "),W=q>0?z.slice(0,q):z,_=q>0?z.slice(q+1).trim():"",H=_&&/=\s*["']/.test(_)?u1(_,"code","code",G):void 0,D=k($,A),F=D,j=!1;while(F<$.length){let E=I($,F),T=F,N=0;while(T<E){let y=b($,T);if(y===C){if(N++,T++,N>=4)break}else if(y===l){if(N+=4-N%4,T++,N>=4)break}else break}if(N<4){let y=A9($,T,X,E-T);if(y>=V){let B=T+y;while(B<E){let R=b($,B);if(R===C||R===l)B++;else break}if(B===E){j=!0;break}if(y>=3&&B<E){let R=T+y;if(!(R<E&&(b($,R)===C||b($,R)===l))){let x=!0;if(X==="`"){if($.slice(R,E).indexOf("`")!==-1)x=!1}if(x)break}}}}else if(Q===4&&J===0&&N===4){let y=A9($,T,X,E-T);if(y>=V&&w1($,T+y,E)){j=!0;break}}F=k($,E)}let v=F>D&&$[F-1]===`
`?F-1:F;if(v>D&&$[v-1]==="\r")v--;let S=p1($.slice(D,v));if(Q)S=r$(S,Q);let w=j&&F<$.length?k($,I($,F)):F;return{type:M.codeBlock,text:S,lang:W,attrs:H,endPos:w}}function l6($,Z,Y){for(var G=0;G<$.length;G++)if(!d$($[G])){let V=e$($,Z,Y,{inline:!1,inBlockQuote:!0});for(var X=0;X<V.length;X++){let K=V[X];if("endPos"in K)delete K.endPos}return V}return[]}function pZ($,Z,Y,G){if(Y.inline)return null;let X=Z;while(X<$.length&&($[X]===" "||$[X]==="\t"))X++;if(X>=$.length||$[X]!==">")return null;let V=Z;var K=[],U=void 0,J=!1,Q=-1,O=!1,A=null,z=null,q=0,W=!1;while(V<$.length){let w=I($,V),E=V;while(E<w&&($[E]===" "||$[E]==="\t"))E++;if(E<w&&$[E]===">"){let T=E+1;if(T<w&&$[T]===" ")T++;let y=t($,T,w).spaceEquivalent>=4,B=!1,R=null,f=0;if(T<w){let P=$[T];if(P==="`"||P==="~"){let g=0,h=T;while(h<w&&$[h]===P&&g<20)g++,h++;if(g>=3)B=!0,R=P,f=g}}if(O&&A==="fenced"&&R===z&&f>=q)O=!1,A=null,z=null,q=0;else if(y||B)O=!0,A=y?"indented":"fenced",z=R,q=f;var _=!y&&!B;if(_){for(var H=T;H<w;H++)if(!d$($[H])){_=!1;break}}if(W=_,Q===-1&&!_)Q=K.length;if(!_)J=!0;let x=E+1;if(x<w&&$[x]==="\t"){K.push("  ");let P=4;for(let g=x+1;g<w;g++){let h=$[g];var D=b(h);if(D===l){let L=4-P%4;if(L===1)K.push(" ");else if(L===2)K.push("  ");else if(L===3)K.push("   ");else K.push(" ".repeat(L));P+=L}else K.push(h),P++}if(w<$.length)K.push(`
...
`)K.pop();let j=K.join("");if(j.length>=4&&j.charCodeAt(0)===g1&&j.charCodeAt(1)===F9){let w=j.indexOf(`]
`,2);if(w>2)U=j.slice(2,w),j=j.slice(w+2)}let v=l6(j,Y,G),S={type:M.blockQuote,children:v,endPos:V};if(U)S.alert=U;return S}function r$($,Z){return $.split(`
...
`},...F.children);else if(D.type===M.heading)K.push(...F.children);else if(!m9(K))K.push({type:M.text,text:" "},...F.children);else K.push(...H);if(H.length>1)K.push(...H.slice(1))}else K.push(...H);return{processed:!0,newPos:k($,Y),wasBlank:!1}}if(U){let D=M$(J,!0,()=>l1(q,0,q.length,J,Q));K.push({type:M.paragraph,children:D})}else V$(q,K,J,Q);return{processed:!0,newPos:k($,Y),wasBlank:!1}}function o$($,Z,Y,G){if(Y.inline)return null;var X=Y.inList;if(Y.inList=!0,Z>0){var V=b($,Z-1);if(V!==d&&V!==V0)return Y.inList=X,null}var K=I($,Z),U=t($,Z,K);if(U.spaceEquivalent>3&&!Y.inList)return Y.inList=X,null;var J=$.slice(Z,K),Q=U.charCount,O=J.slice(Q),A=C$(O);if(!A)return Y.inList=X,null;var{match:z,ordered:q,listItemRegex:W}=A,_=U.spaceEquivalent,H=q?parseInt(z[1],10):void 0,D=q?z[2]:void 0,F=q?void 0:z[1],j=q?z[3]==="":z[2]==="";function v(n,S0){if(n===0)return!0;var y0=b($,n-1);if(y0!==d)return!1;if(!S0)return!0;var U0=n-2;while(U0>=0){var u=b($,U0);if(u!==C&&u!==l)break;U0--}return U0<0||b($,U0)===d}if(j&&!v(Z,!0))return Y.inList=X,null;if(q&&H!==1&&!v(Z,!1))return null;if(!q&&PZ(z,F))return null;var S=z.index||0,w=q?S+z[1].length+z[2].length+1:j?S+z[1].length:S+z[1].length+1,E=Z+Q+w,T=H$($,E,K,_,w),N=T.contentStartColumn,y=_+S+z[1].length,B=q?y+z[2].length+1:j?y:y+1,R=[],f=[];function x(n,S0,y0){return y0?n>=S0:n>S0}function P(){return R[R.length-1]}function g(){return f[f.length-1]??N}function h(n,S0){let y0=uZ(S0),U0=Y.inList;Y.inList=!0;let u=o$($,n,Y,G);if(Y.inList=U0,u)return y0.push(u),u;return null}var L=k($,K),a=L,i=!1;while(a<$.length){var j0=I($,a),w0=$.slice(a,j0);if(w0.trim()===""){var z0=k($,j0);while(z0<$.length){var T0=b($,z0);if(T0===d);else if(!I6.has($[z0]))break;z0++}var p=I($,z0),V1=$.slice(z0,p),X0=t($,z0,p),P0=V1.slice(X0.charCount);if(s1(P0,X0,q,F,D,_,W))i=!0;else{var M0=s$($,z0,p,X0,P0,Y,G);if(M0){var Q0=M0;while(Q0<$.length&&b($,Q0)===d)Q0++;if(Q0<$.length){var a0=I($,Q0),I0=$.slice(Q0,a0),k0=t($,Q0,a0),B1=I0.slice(k0.charCount);if(s1(B1,k0,q,F,D,_,W))i=!0}}}break}var r=t($,a,j0),K0=w0.slice(r.charCount),B0=C$(K0);if(!B0)break;var m0=B0.match;if(q){if(m0[2]!==D)break}else if(m0[1]!==F)break;a=k($,j0)}var H0=q?z[3]:z[2];H0=H0.trimStart();var q0=Z+Q+(z.index||0),e=q?q0+z[1].length+z[2].length:q0+z[1].length,l0=e;while(l0<$.length){var T0=b($,l0);if(T0!==C&&T0!==l)break;l0++}var Y0=0,$0=e;while($0<K){var T0=b($,$0);if(T0===l)Y0+=4-Y0%4;else if(T0===C)Y0++;else break;$0++}var s=!1;if(e<$.length&&b($,e)===l){var r0=1,$1=e+1;while($1<$.length&&b($,$1)===l)r0++,$1++;if(r0>=2)H0="      "+H0,s=!0}if(!q)j=j&&Y0===0;if(Y0>=4&&!s)H0=" ".repeat(Y0-1)+H0.trimStart();var U1=H0.trim()==="";let F1=i;if(!i&&L<$.length){var Q1=L;while(Q1<$.length){var N1=I($,Q1),F0=$.slice(Q1,N1);if(w1($,Q1,N1)){var s0=k($,N1);while(s0<$.length){var O1=I($,s0);if(w1($,s0,O1))s0=k($,O1);else break}if(s0<$.length){var P1=t($,s0,$.length),z1=P1.spaceEquivalent;if(z1>=_){var h0=$.slice(s0,I($,s0)),_1=h0.slice(P1.charCount).match(W),b1=_1&&(q?_1[2]===D:_1[1]===F),W1=null;for(var o=L;o<Q1;o=I($,o)+1){var Z1=I($,o),q1=t($,o,Z1),o0=$.slice(o,Z1).slice(q1.charCount).match(W),z9=o0&&q1.spaceEquivalent>_&&q1.spaceEquivalent>=N&&(q?o0[2]===D:o0[1]===F);if(z9){var y1=q1.spaceEquivalent+1,R1=q?y1+o0[1].length+o0[2].length+1:y1+o0[1].length+1,_9=o+q1.charCount+o0[0].length,N9=H$($,_9,Z1,y1,R1-y1);W1=N9.contentStartColumn;break}}var q9=Y0>=5?B:N;if(!b1&&z1>=q9&&(W1===null||z1+1<W1))F1=!0}}break}var M1=t($,Q1,N1),I1=M1.spaceEquivalent,L1=F0.slice(M1.charCount),T1=L1.match(W),v0=T1&&(q?T1[2]===D:T1[1]===F);if(v0){if(I1<=_)break}Q1=k($,N1)}}var N0=H0;if(c(H0,"```")||c(H0,"~~~")){var p0=q?z[1].length+z[2].length+1:z[1].length+1,S1=lZ($,H0,L,p0);N0=S1.content,L=S1.endPos}var u0=!j&&H0.trim()===""&&Y0>0&&Y0<5;if(!F1){var f0=N0.length>0?N0[0]:"",X1=f0===">",Z=L;while(Z<$.length){var K=I($,Z),J=$.slice(Z,K);if(J.trim()==="")break;var U=t($,Z,K);if(U.spaceEquivalent<B)break;var O=J.slice(U.charCount);if(U.spaceEquivalent<=_&&s1(O,U,q,F,D,_,W))break;if(g$(O)&&U.spaceEquivalent>_)break;var b0=O.length>0?O[0]:"",n1=b0===">"&&X1;if(b0===">"&&!n1||b0==="#"||c(O,"```")||c(O,"~~~"))break;N0+=`
`+O,L=Z=k($,K)}}if(R.push(dZ(N0,F1,Y,G)),f.push(N),F1&&(Y0>=5||u0)){let n=P();L=EZ($,n,B,L,_,q,F,D,W,Y,G,!0)}else if(!F1){let n=B-1;while(L<$.length){let S0=I($,L),y0=$.slice(L,S0),U0=t($,L,S0),u=U0.spaceEquivalent,_0=y0.slice(U0.charCount);if(y0.trim()===""||u<=_&&s1(_0,U0,q,F,D,_,W)||g$(_0)&&u>_||u<n)break;let n0=P(),E0=U$($,L,S0,U0,n,N,n0,!1,Y,G,!0,_);if(E0.processed)L=E0.newPos;else break}}var Z0=!1;while(L<$.length){let n=I($,L),S0=$.slice(L,n),y0=t($,L,n),U0=y0.charCount,u=y0.spaceEquivalent;if(S0.trim()==="")i=!0,Z0=!0,L=k($,n);else if(u<_){let _0=S0.slice(U0);if(_0.startsWith("<")&&SZ($,L,U0,_,u,G))break;let n0=_0.trim();if(n0.length>0&&R.length>0&&!u9(n0[0])&&!s1(_0,y0,q,F,D,_,W)){let E0=P();if(E0.length>0){let J0=E0[E0.length-1];if(!Z0&&(J0.type===M.paragraph||J0.type===M.text)){V$(_0,E0,Y,G),Z0=!1,L=k($,n);continue}}}break}else{let _0=S0.slice(U0);if(R.length>0){let m=f[R.length-1]||N;if(u+1>=m&&!s1(_0,y0,q,F,D,_,W)){let C0=P();if(C0.length>0&&iZ(C0,_0,G)){L=k($,n);continue}}}if(j$($,L,Y,G))break;if(Z0){let m=s$($,L,n,y0,_0,Y,G);if(m){L=m,Z0=!1;continue}}if(u<=_){if(_0.startsWith("<")&&SZ($,L,U0,_,u,G))break;if(!s1(_0,y0,q,F,D,_,W)){if(u===_&&!Z0){let m=_0.trim();if(m.length>0&&!u9(m[0])){let C0=d9($,L,Y,G);if(C0&&C0.type!==M.paragraph)break;let R0=P();if(R0.length>0&&!m9(R0)){V$(_0,R0,Y,G,!0),Z0=!1,L=k($,n);continue}}}break}}if(LZ(R,j,Z0,H0))break;let E0=C$(_0),J0=E0?E0.match:null,A1=J0&&(q?J0[2]===D:J0[1]===F);if(A1&&u>3&&Z0)break;if(A1&&u<=_+3){if(u>=4&&Z0)break;if(u===_){let m=q?J0[3]:J0[2];if(m=m.trimStart(),L=X$($,R,f,m,L,n,u,U0,J0,q,i,Y,G).newCurrentPos,Z0=!1,m.trim()===""){let R0=R[R.length-1],O0=g();L=EZ($,R0,O0,L,_,q,F,D,W,Y,G)}continue}if(u>_){if(Z0){let O0=q?J0[3]:J0[2];O0=O0.trimStart(),L=X$($,R,f,O0,L,n,u,U0,J0,q,i,Y,G).newCurrentPos,Z0=!1;continue}let m=P(),C0=u+1,R0=x(C0,g(),m9(m));if(R0){let O0=h(L,m);if(O0){L=O0.endPos,Z0=!1;continue}}if(!R0&&A1){let O0=q?J0[3]:J0[2];if(O0=O0.trimStart(),!i){let d0=k($,n);while(d0<$.length){let L0=I($,d0),i0=$.slice(d0,L0),D0=t($,d0,L0),Y1=D0.spaceEquivalent;if(i0.trim()===""){let y9=k($,L0);if(y9<$.length){let f1=t($,y9,$.length).spaceEquivalent,B$=u+(q?J0[1].length+J0[2].length+1:J0[1].length+1);if(f1+1>B$)break}break}else if(Y1<=_){let W0=i0.slice(D0.charCount).match(W);if(W0&&(q?W0[2]===D:W0[1]===F)&&Y1<=_)break}d0=k($,L0)}}L=X$($,R,f,O0,L,n,u,U0,J0,q,i,Y,G).newCurrentPos,Z0=!1;continue}else if(!R0&&!A1)break;{let O0=P(),A0=O0.length===0;if(A0&&LZ(R,j,Z0,H0))break;let d0=O0.some((D0)=>D0.type===M.codeBlock||D0.type===M.paragraph||D0.type===M.blockQuote||D0.type===M.orderedList||D0.type===M.unorderedList||D0.type===M.heading),L0=A0&&R.length===1?B:N;if(d0?u>=L0:u>L0){let D0=U$($,L,n,y0,L0,N,P(),Z0,Y,G,void 0,_);if(D0.processed){Z0=D0.wasBlank,L=D0.newPos;continue}}else break}}else if(u===_){if(!q&&J0&&PZ(J0,J0[1]))break;let m=q?J0[3]:J0[2];m=m.trimStart(),L=X$($,R,f,m,L,n,_,U0,J0,q,i,Y,G).newCurrentPos,Z0=!1}}else if(u>_){let m=P();if(g$(_0)){let A0=u+1;if(x(A0,g(),m9(m))){let i0=h(L,m);if(i0){L=i0.endPos,Z0=!1;continue}}if(u-_>3){let i0=m.length>0?m[m.length-1]:null;if(i0&&(i0.type===M.paragraph||i0.type===M.text)){V$(_0,m,Y,G),Z0=!1,L=k($,n);continue}}else break}else{let A0=h(L,m);if(A0){L=A0.endPos,Z0=!1;continue}}let R0=N;if(m9(m)?u>=R0-1:u>R0-1){let A0=U$($,L,n,y0,R0-1,N,P(),Z0,Y,G,void 0,_);if(A0.processed){Z0=A0.wasBlank,L=A0.newPos;continue}}else break}else break}}if(i&&R.length>1&&R[0].length>0&&R[0][0].type!==M.paragraph){for(var G0=1;G0<R.length;G0++)if(R[G0].length>0&&R[G0][0].type===M.paragraph){var E1=!1;for(var v1=0;v1<R[0].length;v1++){var G1=R[0][v1].type;if(G1===M.codeBlock||G1===M.heading||G1===M.blockQuote||G1===M.orderedList||G1===M.unorderedList||G1===M.htmlBlock||G1===M.breakThematic){E1=!0;break}}if(!E1)R[0]=[{type:M.paragraph,children:R[0]}];break}}let b9=q?{type:M.orderedList,items:R,ordered:!0,start:H}:{type:M.unorderedList,items:R,ordered:!1};return Y.inList=X,{...b9,endPos:L}}function cZ($,Z,Y,G){if(Y.inline)return null;let X=[],V=Z;while(V<$.length){let W=I($,V);if(w1($,V,W))break;let _=$.slice(V,W).trim();if(!(_.indexOf("|")!==-1||X.length>=3&&_&&!u9(_[0])))break;X.push(_),V=k($,W)}if(X.length<2)return null;let K=(W)=>W[0]==="|"&&W[W.length-1]==="|"?W.slice(1,-1):W,U=(W)=>{let _=[],H="",D=!1;for(let F=0;F<W.length;F++){let j=W[F];if(j==="\\"&&F+1<W.length&&W[F+1]==="|")H+="|",F++;else if(j==="`")D=!D,H+=j;else if(j==="|"&&!D)_.push(H.trim()),H="";else H+=j}return _.push(H.trim()),_},J=U(K(X[0]));if(!J.length)return null;let Q=U(K(X[1]));if(Q.length!==J.length||Q.some((W)=>!/^:?-+:?$/.test(W)))return null;let O=Q.map((W)=>{let _=W[0]===":",H=W[W.length-1]===":";return _&&H?"center":_?"left":H?"right":null});if(G.optimizeForStreaming&&X.length===2)return null;let A=(W)=>M$(Y,!0,()=>W.map((_)=>l1(_,0,_.length,Y,G))),z=A(J),q=X.slice(2).map((W)=>{let _=W.indexOf("|")!==-1?U(K(W)):[W.trim()],H=J.length;while(_.length<H)_.push("");return _.length=H,A(_)});return{type:M.table,header:z,cells:q,align:O,endPos:V}}var i6=["div","p","section","article","aside","nav","header","footer","main","h1","h2","h3","h4","h5","h6","blockquote","ul","ol","li","dl","dt","dd","table","thead","tbody","tfoot","tr","td","th","form","fieldset","hr","pre","details","summary","figure","figcaption"],c6=new Set(["pre","script","style","textarea"]);function h9($){return i6.indexOf($.toLowerCase())!==-1}function w9($){return c6.has($)}function w1($,Z,Y){for(var G=Z;G<Y;G++){let X=b($,G);if(X!==C&&X!==l&&X!==V0)return!1}return!0}function M$($,Z,Y){let G=$.inline;$.inline=Z;try{return Y()}finally{$.inline=G}}function k$($,Z,Y){var G=Z;while(G<Y){var X=I($,G);if(w1($,G,X))return G;G=k($,X)}return Y}function m$($,Z,Y){return{type:M.htmlComment,text:p1($),endPos:Z,...Y}}function v9($,Z,Y,G,X,V,K,U,J){var Q=p1(Z),O=Q;if(U&&(U.forceBlock||U.optimizeForStreaming)&&Z&&!V){var A=new RegExp("^<"+$.toLowerCase()+"(\\s[^>]*)?>$","i");if(A.test(Z.trim()))O=""}var z=O,q=$.toLowerCase(),W=new RegExp("^<"+q+"[\\s>]","i");if(W.test(z)){var _=z.indexOf(">");if(_!==-1){z=z.slice(_+1);var H="</"+q+">",D=z.indexOf(H);if(D!==-1)z=z.slice(0,D)}}else{var F="</"+q+">",j=z.indexOf(F);if(j!==-1)z=z.slice(0,j)}var v=[];if(z&&U&&!U.optimizeForStreaming){var S=J||{inline:!1,inHTML:!0,inAnchor:!1},w=z.trim(),E=O$.test(w),T=W$.test(w),N=F$.test(w);if(E||T||N){var y={...S,inline:!1,inHTML:!0,inAnchor:S.inAnchor||q==="a"};v=i9(w,y,U)}else if(w){var B={...S,inline:!0,inHTML:!0,inAnchor:S.inAnchor||q==="a"};v=l1(w,0,w.length,B,U)}}return{type:M.htmlBlock,tag:$,attrs:G||{},rawAttrs:X,children:v,rawText:O,text:z,verbatim:!0,isClosingTag:V,canInterruptParagraph:K,endPos:Y}}function p9($){let Z=W$.test($),Y=O$.test($),G=y6.test($);return Z||Y&&!G}function IZ($,Z,Y,G,X,V,K,U,J,Q){if(!U.inHTML&&!U.inline&&!t9(X,`
`)){let X0=V,P0=K.length;while(X0<P0){let M0=I(K,X0);if(w1(K,X0,M0))break;let Q0=K.slice(X0,M0).trim();if(Q0.length>0&&u9(Q0[0])){let a0=v$(K,X0,U,Q);if(a0){X0=a0.endPos;continue}let I0=o1(K,X0);if(I0){X0=I0.endPos;continue}return null}X0=k(K,M0)}}let O=Z,A=w9(O);var z=!A&&!K9(Z),q=void 0;if(X){var W=X.indexOf(">");if(W!==-1){var _=X.slice(0,W+1);if(_.indexOf(`
`)!==-1)q=_;var H=W;for(var D=1;D<W;D++){var F=_[D];if(F===" "||F==="\t"||F===`
`||F===">"){H=D;break}}Y=_.slice(H,W)}}var j=Y.replace(/^[\s\n\r\t]+/,""),v=u1(j,Z,$,Q),S={...v},w=!1,E=!1;if(z&&G.length>0){var T="</"+O,N=G.indexOf(T);if(N>=0){var y=N+T.length;while(y<G.length&&(G[y]===" "||G[y]==="\t"))y++;if(y<G.length&&G[y]===">"){var B=G.slice(0,N);if(p9(B))G=B,E=!0;else w=!0}}if(!E){var R=G.length-1;if(G[R]===`
`){R--;while(R>=0&&(G[R]===" "||G[R]==="\t"||G[R]==="\r"))R--;if(R>=0&&G[R]===`
`)w=!0}}}var f=A||z&&w&&!p9(G),x=p1(G),P=x;if(f){if(x.length>0&&x[0]===`
`)x=x.slice(1),P=x;if(x.length>0&&x[x.length-1]===`
`)x=x.slice(0,-1),P=x;var T="</"+O+">",N=x.indexOf(T);if(N!==-1)x=x.slice(0,N)}let g=x.match(/^([ \t]*)/),h=g?g[1]:"",L=new RegExp(`^${h.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}`,"gm"),a=x.replace(L,""),i=O$.test(a),j0=W$.test(a),w0=O==="p",z0=F$.test(a),T0=w0?i:i||j0||U.inHTML&&z0,p=[];if(a)if(T0||z0){let X0={...U,inline:!1,inHTML:!0,inAnchor:U.inAnchor||O==="a"};p=i9(a,X0,Q)}else{let X0={...U,inline:!0,inHTML:Q.optimizeForStreaming?!0:U.inHTML,inAnchor:J||U.inAnchor||O==="a"};p=l1(a,0,a.length,X0,Q)}var V1=void 0;if(f)if(q!==void 0)V1=q+P;else V1=P;return{type:M.htmlBlock,tag:f?Z:$,attrs:S,rawAttrs:Y,children:p,rawText:V1,text:a,verbatim:f,canInterruptParagraph:!0,endPos:V}}function v$($,Z,Y,G){if($[Z]!=="<")return null;if(G.optimizeForStreaming&&Y.inHTML)return null;if(!Y.inline);if(Z+1<$.length){if($[Z+1]==="?"){var X=Q$($,Z);if(X&&X.kind==="pi")return m$(X.text||"",X.endPos,{raw:!0})}else if($[Z+1]==="!"){if(Z+3<$.length&&$.slice(Z,Z+4)==="<!--"){if(Y.inline);var V=Q$($,Z);if(V&&V.kind==="comment"){var K=V.text||"",U=!1;if(K==="<!-->")K="",U=!0;else if(K==="<!--->")K="-",U=!0;else if(K.startsWith("<!--")&&K.endsWith("-->"))K=K.slice(4,-3);if(Y.inline);return m$(K,V.endPos,{endsWithGreaterThan:U})}}var J=Q$($,Z);if(J&&(J.kind==="declaration"||J.kind==="cdata"))return m$(J.text||"",J.endPos,{raw:!0})}}if(Z+1<$.length){let D9=$[Z+1];if(D9===" "||D9===`
`||D9==="\t"||D9==="\r")return null}var Q=$.indexOf(">",Z+1);if(Q!==-1){var O=$.slice(Z+1,Q),A=O.indexOf(" ")!==-1||O.indexOf("\t")!==-1;if(!A&&(c(O,"http://")||c(O,"https://")))return null;if(!A&&kZ(O))return null}var z=o1($,Z);if(!z&&!Y.inline){var q=$.length,W=I($,Z),_=Z,H=0;while(_<W&&H<3&&($[_]===" "||$[_]==="\t"))H++,_++;if(_>=W||$[_]!=="<")return null;if(_+1<W){var D0=i$($,_+1);if(D0){var Y1=D0.tagName,D=h9(Y1);if(!D)return null;var F=D0.nextPos,j=!1,v=!1,S="",w=W,E=!1;while(w<q&&!E){var T=!1;while(F<w){var N=$[F];if(v){if(N===S)v=!1,S="";if(N===`
`||N==="\r")j=!0;F++,T=!0}else if(N==='"'||N==="'")v=!0,S=N,F++,T=!0;else if(N===`
`||N==="\r"){j=!0,F++,T=!0;var y=I($,F);if(y===F)break;w=y}else if(N===">"){F++,E=!0;break}else F++,T=!0}if(E)break;if(!T&&F>=w){var B=I($,w+1);if(B<=w)break;w=B}else if(F>=w&&w<q){var B=I($,w+1);if(B<=w)break;w=B}else break}if(!j&&E)return null;if(F>=W&&W<q)F=W;var R=D?"type6":"type7",f=F,x=k$($,k($,W),q),P=$.slice(f,x),g=Z+1<$.length&&$[Z+1]==="/";if(R==="type7"&&P.trim()===""){var h=$.slice(Z,x),L=I(h,0);if(L<h.length)L++;var a=h.slice(0,L);return v9(Y1,a,x,{},void 0,g,!1,G,Y)}var i=$.slice(Z,x);return v9(Y1,i,x,{},void 0,g,R==="type6",G,Y)}}return null}if(!z)return null;if(Q!==-1){var j0=$.slice(Z+1,Q);if((c(j0,"http://")||c(j0,"https://"))&&(j0.indexOf(" ")!==-1||j0.indexOf("\t")!==-1))return null}var P0=Z+(z.isClosing?2:1);if(P0<$.length){var w0=$[P0],z0=b(w0);if(z0>=97&&z0<=122||z0>=65&&z0<=90){if(P0+1<$.length&&$[P0+1]===":")return null}}if(z.isClosing){var T0=z.attrs.trim();if(T0.length>0)return null;if(!Y.inline){var q=$.length,W=I($,Z),f=z.endPos,p=f;while(p<W&&($[p]===" "||$[p]==="\t"||$[p]==="\r"))p++;var V1=p>=W||$[p]==="<"&&function(){var JZ=o1($,p);return JZ&&h9(JZ.tagLower)}();if(V1){var x=k$($,k($,W),q),P=$.slice(f,x);if(P.length>0){if(P[0]==="\r"&&P[1]===`
`)P=P.slice(2);else if(P[0]===`
`||P[0]==="\r")P=P.slice(1)}let G6=z.tagLower||z.tagName.toLowerCase();return v9(z.tagName,P,x,u1(z.whitespaceBeforeAttrs+z.attrs,G6,z.tagName,G),z.whitespaceBeforeAttrs+z.attrs,!0,!1,G,Y)}}var X0=$.slice(Z,z.endPos);return{type:M.htmlSelfClosing,tag:z.tagName,attrs:{},endPos:z.endPos,isClosingTag:!0,rawText:X0}}var P0=Z+(z.isClosing?2:1);if(P0<$.length){var M0=$[P0];if(M0===" "||M0==="\t"||M0===`
`||M0==="\r")return null}var Q0=z.tagLower,a0=K9(z.tagName);let I0=z.tagName.length>0&&z.tagName[0]>="A"&&z.tagName[0]<="Z";if(z.isSelfClosing||a0&&Q0!=="a"){if(z.hasNewline&&!I0)return null;if(!Y.inHTML&&!Y.inline&&!I0)return null;var k0=z.attrs.replace(/\/\s*$/,""),B1=u1(k0,Q0,z.tagName,G),X0=Y.inline?$.slice(Z,z.endPos):void 0;let XZ={type:M.htmlSelfClosing,tag:z.tagName,attrs:B1,endPos:z.endPos};if(X0!==void 0)XZ.rawText=X0;return XZ}if(Y.inline){var r=z.attrs.replace(/\/\s*$/,""),K0=z.whitespaceBeforeAttrs+r,B0=u1(r,Q0,z.tagName,G),m0={...B0},H0=z.endPos,q0=[];if(!K9(z.tagName)){var e=N6($,z.endPos,Q0);if(e!==null){var l0=$.slice(z.endPos,e[0]);if(l0)if(Y.inHTML&&F$.test(l0)||p9(l0))q0=i9(l0,{...Y,inline:!1,inHTML:!0,inAnchor:Y.inAnchor||Q0==="a"},G);else q0=l1(l0,0,l0.length,{...Y,inline:!0,inHTML:G.optimizeForStreaming?!0:Y.inHTML,inAnchor:Y.inAnchor||Q0==="a"},G);H0=e[1]}}return{type:M.htmlBlock,tag:z.tagName,attrs:m0,rawAttrs:K0,children:q0,verbatim:!1,endPos:H0}}if(!Y.inline){var q=$.length,W=I($,Z),Y0=z.tagLower,$0=w9(Y0),s=!$0&&h9(z.tagName),r0=!1,$1=Z;while($1<z.endPos){if($[$1]===">"){r0=!0;break}$1++}var p=z.endPos;while(p<W&&($[p]===" "||$[p]==="\t"))p++;var U1=p>=W||$[p]===`
...
`&&o0!=="\r")break;o++}if(o>=q||$[o]!==">"){F0=o;continue}var z9=o+1,y1=I($,z9);O1=y1,F0=y1+1,P1--}}var R1=0;while(F0+R1<q&&$[F0+R1]===`
`)R1++;var _9=$.slice(Z,F0+R1),N9=$.slice(s0,O1),q9=F0+R1;return IZ(z.tagName,z.tagName,N1,N9,_9,q9,$,Y,!1,G)}if(U1||!r0){var R=s?"type6":"type7",f=z.endPos,x=k$($,k($,W),q);if(R==="type6"&&!z.isClosing){let r9=I0?z.tagName:z.tagLower||z.tagName.toLowerCase();var M1="</"+r9,I1="<"+r9,L1=f,T1=1,v0=-1;while(L1<x&&T1>0){var N0=$.indexOf(I1,L1),p0=$.indexOf(M1,L1);while(N0!==-1&&N0<x){var S1=N0+I1.length;if(S1>=q){N0=-1;break}var u0=$[S1];if(u0===" "||u0==="\t"||u0===`
`||u0==="\r"||u0===">")break;N0=$.indexOf(I1,S1)}if(N0===-1||N0>=x)N0=x;if(p0===-1||p0>=x)p0=x;if(N0<p0)T1++,L1=N0+I1.length;else if(p0<x){if(T1--,T1===0){v0=p0;break}L1=p0+M1.length}else break}if(v0!==-1&&v0<x){var f0=v0+M1.length;while(f0<q&&($[f0]===" "||$[f0]==="\t"))f0++;if(f0<q&&$[f0]===">"){var X1=f0+1,b0=X1;while(b0<q&&$[b0]!==`
`)b0++;if(b0<q)b0++;while(b0<q&&($[b0]===" "||$[b0]==="\t"))b0++;if(b0<q&&$[b0]==="<"&&!c($.slice(b0),M1)){var n1=o1($,b0);if(n1)x=X1}}}else if(v0=$.indexOf(M1,f),v0!==-1){var a9=$.slice(f,v0),Z0=I0||p9(a9);if(Z0){var G0=v0+M1.length;while(G0<q&&($[G0]===" "||$[G0]==="\t"))G0++;if(G0<q&&$[G0]===">"){var E1=I($,G0+1);x=E1}}}}var P=$.slice(f,x),v1=z.whitespaceBeforeAttrs+z.attrs,g=z.isClosing;let KZ=()=>{let r9=z.tagLower||z.tagName.toLowerCase(),L9=z.whitespaceBeforeAttrs+z.attrs;return{parsed:u1(L9,r9,z.tagName,G),raw:L9}};if(R==="type7"&&P.trim()===""){var G1=$.slice(Z,z.endPos),b9=G1.indexOf(`
`)!==-1;if(b9)return null;var n=z.endPos,L=I($,n);if(L<$.length)L++;var a=$.slice(Z,L);let UZ=KZ();return v9(z.tagName,a,x,UZ.parsed,UZ.raw,g,!1,G,Y)}var S0=z.hasNewline,y0=!r0;if((S0||y0)&&R==="type7"){var U0=z.endPos,u=$.slice(Z,U0),_0=P,i=u+_0;let L9=KZ();return v9(z.tagName,i,x,L9.parsed,L9.raw,g,!1,G,Y)}let VZ=z.tagLower||z.tagName.toLowerCase();var n0=u1(v1,VZ,z.tagName,G),E0={...n0};if(R==="type6"){var J0=P,A1=P.indexOf("</"+VZ);if(A1>=0){var p=A1+2+z.tagName.length;while(p<P.length&&(P[p]===" "||P[p]==="\t"))p++;if(p<P.length&&P[p]===">")J0=P.slice(0,A1)}if(p9(J0))return IZ(z.tagName,z.tagName,v1,J0,$.slice(Z,z.endPos),x,$,Y,!1,G)}var m=P;if(m.length>0){if(m[0]==="\r"&&m[1]===`
...
`)}return v9(z.tagName,m,x,E0,v1,g,R==="type6"?!0:!1,G,Y)}}if(Y.inline)return null;var D0=i$($,Z+1);if(!D0)return null;var Y1=D0.tagName;if(!K9(Y1))return null;let y9=D0.tagLower;var W0=D0.nextPos,f1=$.length;while(W0<f1&&j1($[W0]))W0++;var GZ=W0;while(W0<f1&&$[W0]!==">")W0++;if(W0>=f1)return null;let B$=$.slice(GZ,W0).trim(),R9=W0+1;while(R9<f1&&j1($[R9]))R9++;let eZ="</"+y9+">",YZ=$.toLowerCase().indexOf(eZ,R9);if(YZ!==-1){if($.slice(R9,YZ).trim())return null}W0++;let $6=W0;while(W0<f1&&j1($[W0]))W0++;if(W0<f1&&$[W0]===`
`)W0++;let Z6=u1(B$,Y1,Y1,G);return{type:M.htmlSelfClosing,tag:Y1,attrs:Z6,endPos:$6}}function a6($,Z){if($[Z]!=="<")return null;var Y=$.length,G=!1,X=Z+1;if(Z+1<Y&&$[Z+1]==="/")G=!0,X=Z+2;var V=i$($,X);if(!V)return null;var{tagName:K,tagLower:U,nextPos:J}=V;if(J<Y){var Q=$[J];if(Q===">"||Q==="/"){var O=Q===">"?J+1:J+2;if(Q==="/"&&(J+1>=Y||$[J+1]!==">"))return null;var A=Q==="/",z=h9(K),q=!w9(U)&&!z;return{kind:"tag",tagNameLower:U,tagName:K,isClosing:G,isSelfClosing:A,hasNewline:!1,type6Candidate:z,type7Candidate:q,endPos:O,attrs:"",whitespaceBeforeAttrs:""}}}var W=J,_=!1;while(J<Y){var H=$[J],D=b($,J);if(H===" "||H==="\t");else if(D===10||D===13)_=!0;else break;J++}var F=$.slice(W,J),j=J,v=!1,S="",w=0,E=!1,T=!1,N=0;while(j<Y){var y=$[j],D=b($,j);if(N===1){if(y==='"'){if(j+1<Y&&$[j+1]==='"')return null;N=0}j++}else if(N===2){if(y==="'")N=0;j++}else if(y==='"')N=1,j++;else if(y==="'")N=2,j++;else if(y==="{"||y==="}"&&w>0)w+=y==="{"?1:-1,j++;else if(y===">"&&w===0){if(j>J){var B=j-1;while(B>=J){var R=$[B];if(R!==" "&&R!=="\t")break;B--}if(B>=J&&$[B]==="/")E=!0,T=B<j-1}j++;break}else{if(y==="*"||y==="#"||y==="!"){var f=j+1;while(f<Y){var x=$[f];if(x==="="||x===" "||x==="\t"||x===`
`||x==="\r"||x===">")break;f++}if(f<Y&&$[f]==="=")return null}if(D===10||D===13)_=!0;j++}}if(j>Y||$[j-1]!==">")return null;if(N===1||N===2)return null;if(w>0)return null;if(T)return null;var P=j-1;if(E)P--;var g=$.slice(J,P),h=E,L=-1,a=!1,i="",j0=!1;for(var w0=0;w0<g.length;w0++){var H=g[w0];if(a){if(H===i)a=!1,L=w0,i="",j0=!1}else if(H==='"'||H==="'")a=!0,i=H,j0=!1;else if(H==="=")j0=!0;else if(L!==-1&&w0===L+1){var D=H.charCodeAt(0);if(Q9(D))return null}else if(j0&&!a&&(H==="*"||H==="#"||H==="!"))return null;else if(j1(H))j0=!1}var z0=h9(K),T0=!w9(U)&&!z0;return{kind:"tag",tagNameLower:U,tagName:K,isClosing:G,isSelfClosing:h,hasNewline:_,type6Candidate:z0,type7Candidate:T0,endPos:j,attrs:g,whitespaceBeforeAttrs:F}}function Q$($,Z){if(Z>=$.length||$[Z]!=="<")return null;var Y=$.length;if(Z+1>=Y)return null;var G=$[Z+1];if(G==="!"){if(Z+4<=Y&&$.slice(Z,Z+4)==="<!--"){var X=Z+4;if(X<Y&&$[X]===">")return{kind:"comment",hasNewline:!1,endPos:X+1,text:$.slice(Z,X+1),raw:!0};if(X+1<Y&&$[X]==="-"&&$[X+1]===">")return{kind:"comment",hasNewline:!1,endPos:X+2,text:$.slice(Z,X+2),raw:!0};while(X+2<Y){if($.slice(X,X+3)==="-->")return{kind:"comment",hasNewline:!1,endPos:X+3,text:$.slice(Z,X+3),raw:!0};X++}return null}if(Z+9<=Y&&$.slice(Z,Z+9)==="<![CDATA["){var X=Z+9;while(X+2<Y){if($.slice(X,X+3)==="]]>")return{kind:"cdata",hasNewline:!1,endPos:X+3,text:$.slice(Z,X+3),raw:!0};X++}return null}if(Z+2<Y&&Q9($.charCodeAt(Z+2))){var X=Z+2;while(X<Y&&$[X]!==">")X++;if(X>=Y)return null;return{kind:"declaration",hasNewline:!1,endPos:X+1,text:$.slice(Z,X+1),raw:!0}}return null}if(G==="?"){var X=Z+2;while(X+1<Y){if($.slice(X,X+2)==="?>")return{kind:"pi",hasNewline:!1,endPos:X+2,text:$.slice(Z,X+2),raw:!0};X++}return null}return a6($,Z)}function h$($,Z){if(Z>=$.length)return!1;var Y=$[Z];return Y==="="||Y==="-"||Y==="_"||Y==="*"||Y==="#"||Y===">"||Y==="`"||Y==="~"||Y==="["||Y>="0"&&Y<="9"}function J$($,Z){if(Z>=$.length)return!1;var Y=$[Z];return Y==='"'||Y==="'"||Y==="("}function r6($,Z,Y){var G=$.length;if(Z>=G||$[Z]!==Y)return null;Z++;var X=Z,V=!1;while(Z<G&&$[Z]!==Y){var K=$.charCodeAt(Z);if(K===d){if(V)return null;V=!0,Z++}else if(K===V0)if(Z+1<G&&$.charCodeAt(Z+1)===d){if(V)return null;V=!0,Z+=2}else V=!1,Z++;else{if(V=!1,K===k1&&Z+1<G)Z++;Z++}}if(Z>=G)return null;return{value:$.slice(X,Z),endPos:Z+1}}function s6($,Z){var Y=$.length;if(Z>=Y||$[Z]!=="(")return null;Z++;var G=Z,X=1,V=!1;while(Z<Y&&X>0){var K=$.charCodeAt(Z);if(K===d){if(V)return null;V=!0,Z++}else if(K===V0)if(Z+1<Y&&$.charCodeAt(Z+1)===d){if(V)return null;V=!0,Z+=2}else V=!1,Z++;else{if(V=!1,K===k1&&Z+1<Y)Z++;else if(K===HZ)X++;else if(K===FZ)X--;Z++}}if(X!==0)return null;return{value:$.slice(G,Z-1),endPos:Z}}function o6($,Z){var Y=$.length,G=Z;while(G<Y){var X=G===0||$[G-1]===`
`,V=$.charCodeAt(G);if(V===d&&G>Z){var K=G+1;if(K<Y&&$.charCodeAt(K)===V0)K++;if(K<Y&&$.charCodeAt(K)===d){var U=K+1;while(U<Y&&($[U]===" "||$[U]==="\t"))U++;var J=U-(G+1);if($.charCodeAt(G+1)===V0)J--;if(U<Y&&$.charCodeAt(U)!==d&&$.charCodeAt(U)!==V0&&J<4)return G}}if(X&&c($,"[^",G)){var Q=G+2;while(Q<Y&&$[Q]!=="]")Q++;if(Q<Y&&$[Q]==="]"&&Q+1<Y&&$[Q+1]===":")return G}G++}return Y}function n6($,Z,Y){let G=$.length,X=Z,V=X<G&&$[X]==="<";if(V)X++;let K=X,U=K;if(K>=G){if(!V)return null;U=K}else if(Y>0&&K<G&&$[K]===`
`)return null;else while(U<G){if(V&&$[U]===">")break;if($[U]===`
`){let N=U+1;if(N>=G)break;if(N<G&&$[N]===`
`)break;let y=N;while(y<G&&($[y]===" "||$[y]==="\t"))y++;if(y<G&&J$($,y))break;if(y<G&&$[y]==="[")break;if(y<G){let B=$[y];if(h$($,y))break;if(B>="a"&&B<="z"){let R=y+1;while(R<G&&R<y+32&&($[R]>="a"&&$[R]<="z"||$[R]>="A"&&$[R]<="Z"||$[R]>="0"&&$[R]<="9"||$[R]==="+"||$[R]==="."||$[R]==="-"))R++;if(R<G&&$[R]===":");else break}}U=y;continue}if(!V&&($[U]===" "||$[U]==="\t")){let N=U+1;while(N<G&&($[N]===" "||$[N]==="\t"))N++;if(N<G&&J$($,N))break;if(N<G&&$[N]===`
`){let y=N+1;if(y<G&&$[y]===`
`)break;let B=y;while(B<G&&($[B]===" "||$[B]==="\t"))B++;if(B<G&&J$($,B))break}}U++}if(V&&(U>=G||$[U]!==">"))return null;let J=$.slice(K,U),Q=[],O=0;for(let N=0;N<=J.length;N++)if(N===J.length||J[N]===`
...
`){var z=X+1,q=z;while(q<G&&($[q]===" "||$[q]==="\t"))q++;if(q<G){let N=$[q];if(h$($,q))A=!0;if(!A&&N!=="="&&N!=="-"){var W=I($,q);if(W<G){var _=k($,W),H=_;while(H<G&&($[H]===" "||$[H]==="\t"))H++;if(H<G){var D=$[H];if(D==="="||D==="-")A=!0}}}}}if(!A&&X<G&&J$($,X))return null;let F=0;while(X<G&&!A){let N=$[X];if(N===`
`){if(F++,F>1)break;X++;var j=X;if(X=g0($,X),X<G&&V9($[X])&&$[X]!==`
`){X=j-1;break}if(X<G){let y=$[X];if(h$($,X)){A=!0,X=j-1;break}}}else if(N===" "||N==="\t")X++;else if(V9(N))break;else break}let v=void 0;if(X<G){let N=$[X];var S=N==="("?s6($,X):N==='"'||N==="'"?r6($,X,N):null;if(S===null&&(N==='"'||N==="'"||N==="("))return null;if(S){v=S.value,X=S.endPos;var w=X;while(w<G&&($[w]===" "||$[w]==="\t"))w++;if(w<G&&$[w]!==`
`&&$[w]!=="\r")return null;X=w}}if(X=g0($,X),X<G&&$[X]!==`
`){var E=X;while(E<G&&$[E]!==`
`){if($[E]!==" "&&$[E]!=="\t")return null;E++}}if(v===void 0&&X<G&&$[X]!==`
`){var T=X;while(T<G&&$[T]!==`
`){if($[T]!==" "&&$[T]!=="\t")return null;T++}}return{endPos:X<G&&$[X]===`
`?X+1:X,target:J,title:v}}function t6($,Z){let Y=Z,G=o6($,Z),X=G<$.length&&$[G]===`
`&&$[G+1]===`
...
`||q===" ")z--;else break}if(z<A.length)A=A.slice(0,z);return{endPos:G,target:A,title:void 0}}function B9($,Z,Y,G,X){if($[Z]!=="[")return null;var V=Z+1<$.length&&$[Z+1]==="^";if(X?!V:V)return null;var K=Z;while(K>0&&$[K-1]!==`
`)K--;if(t($,K,Z).spaceEquivalent>=4||Y.inline)return null;var U=Z+(X?2:1),J=$.length,Q=T6($,U,J,"]");if(Q===-1)return null;var O=$.slice(U,Q);if(O.length>999)return null;var A=!1,z=!1,q=!1;for(var W=0;W<O.length;W++){var _=O[W];if(_==="\\"&&W+1<O.length){W++;continue}var H=b(_);if(H===g1||H===H9)z=!0;else if(H===d||H===V0)q=!0;else if(H!==C&&H!==l)A=!0}if(!A||z)return null;var D=Q+1;if(q){var F=b($,U),j=b($,Q-1);if(F===d||F===V0||j===d||j===V0||D>=J||$[D]!==":")return null}else if(D>=J||$[D]!==":"){if(D=g0($,D),D<J&&b($,D)===d)D=g0($,D+1);if(D>=J||$[D]!==":")return null}D++;var v=0;while(D<J){var S=b($,D);if(S===d){if(++v>1)break;D=g0($,D+1)}else if(S===C||S===l)D++;else break}let w=X?t6($,D):n6($,D,v);if(!w)return null;let E=mZ(O),T=Y.refs||{},N=X?`^${E}`:E;if(!T[N])T[N]={target:z$(w.target.trim()),title:w.title?z$(w.title):void 0},Y.refs=T;return{type:X?M.footnote:M.ref,endPos:w.endPos}}function aZ($,Z,Y){var G=[],X=Y===null?0:Y+1;while(X<Z.length){var V=Z[X];if(!V||V.type!=="*"&&V.type!=="_"&&V.type!=="~"&&V.type!=="="){X++;continue}if(!V.canClose||!V.active){X++;continue}var K=V.type==="*"?0:V.type==="_"?1:V.type==="~"?2:3,U=K*6+V.length%3*2+(V.canOpen?1:0),J=G[U]!==void 0?G[U]:Y===null?-1:Y,Q=-1,O=V.type,A=V.inAnchor,z=V.canOpen,q=V.length,W=q%3;for(var _=X-1;_>J;_--){var H=Z[_];if(!H||!H.active||H.type!==O||!H.canOpen||H.inAnchor!==A)continue;var D=H.length;if(!z&&!H.canClose||W===0||(D+q)%3!==0){Q=_;break}}if(Q>=0){var F=Z[Q],D=F.length,j=D>=2&&q>=2,v=j?2:1;if(v>D||v>q){X++;continue}var S=F.nodeIndex,w=V.nodeIndex,E=S+1,T=w,N=$.slice(E,T);if(N.length>0){var y=T-E;$.splice(E,y);for(var B=0;B<Z.length;B++)if(Z[B].nodeIndex>E)Z[B].nodeIndex-=y;if(w>E)w-=y}var R=F.type==="~"?"del":F.type==="="?"mark":j?"strong":"em",f={type:M.textFormatted,tag:R,children:N},x=$[S];if(!x||!x.text){F.active=V.active=!1;continue}var P=x.text.length<=v;if(P){$.splice(S,1);for(var B=0;B<Z.length;B++)if(Z[B].nodeIndex>S)Z[B].nodeIndex--;if(w>S)w--}else x.text=x.text.slice(v);var g=$[w];if(!g||!g.text){F.active=V.active=!1;continue}var h=g.text.length<=v;if(h){$.splice(w,1);for(var B=0;B<Z.length;B++)if(Z[B].nodeIndex>w)Z[B].nodeIndex--}else g.text=g.text.slice(v);var L=P?S<w?w-1:S:S+1;if(L<0||L>$.length)L=L<0?0:$.length;$.splice(L,0,f);for(var B=0;B<Z.length;B++)if(Z[B].nodeIndex>=L)Z[B].nodeIndex++;for(var B=Q+1;B<X;B++)Z[B].active=!1;if(P)F.active=!1;else if(F.length-=v,F.length===0)F.active=!1;if(h)V.active=!1,X++;else if(V.length-=v,V.length===0)V.active=!1,X++}else{if(G[U]=X-1,!V.canOpen)V.active=!1;X++}}var a=0;for(var _=0;_<Z.length;_++)if(Z[_].active)Z[a++]=Z[_];Z.length=a}function c9($,Z,Y){var G=[],X=0,V=-3,K=V;if(Z.inline)return l1($,0,$.length,Z,Y);if(X===0&&$.startsWith("---")){var U=u6($,X);if(U)G.push(U),X=U.endPos}while(X<$.length){while(X<$.length&&$[X]===`
`)X++;if(X>=$.length)break;K=V;let A=$[X],z=d9($,X,Z,Y);if(z){let D=z.type;if(D===M.codeBlock){var J=A==="`"||A==="~";if(!J&&(A===" "||A==="\t")){let F=I($,X),j=t($,X,F);J=j.spaceEquivalent<=3&&X+j.charCount<$.length&&($[X+j.charCount]==="`"||$[X+j.charCount]==="~")}}else if(D===M.breakThematic);else if(D===M.blockQuote);else if(D===M.heading);else if(D===M.orderedList||D===M.unorderedList);else if(D===M.table);else if(D===M.htmlComment);else if(D===M.htmlBlock);else if(D===M.ref);if(z.type===M.htmlComment){G.push(z);let F=X;X=z.endPos;let j=I($,F);if(X<j){let v=$.slice(X,j);if(v.trim().length>0)G.push({type:M.text,text:v});if(X=j,X<$.length&&$[X]===`
`)X++}continue}if(z.type===M.htmlBlock||z.type===M.htmlSelfClosing)if(z.type===M.htmlSelfClosing&&z.isClosingTag===!0&&!Z.inline&&!Z.inHTML);else{G.push(z),X=z.endPos;continue}else{G.push(z),X=z.endPos;continue}}let q=K!==V?K:X;if(K===V){if(j1(A)){let D=I($,X),F=t($,X,D),j=X+F.charCount;if(F.spaceEquivalent<=3&&j<$.length&&$[j]==="[")q=j;else q=-1}else if(A==="[")q=X;else q=-1;K=q}if(q>=0&&q+1<$.length&&$[q+1]==="^")q=-1;if(q>=0){let D=B9($,q,Z,Y,!1);if(D){G.push(D),X=D.endPos;continue}let F=x6($,q,X===0);if(F.shouldSkip){X=F.newPos;continue}}let W=hZ($,X,Z,Y);if(W){G.push(W),X=W.endPos;continue}let _=X;if(j1($[_])){let D=I($,X),F=t($,X,D);_=X+F.charCount}if(_<$.length&&$[_]==="["&&_+1<$.length&&$[_+1]==="^"){let D=B9($,_,Z,Y,!0);if(D){X=D.endPos;continue}}let H=a$($,X,Z,Y);if(H){G.push(H),X=H.endPos;continue}X++}let Q=Z.refs||{},O={};for(let A in Q)O[A]=Q[A];if($$(O))return[{type:M.refCollection,refs:O},...G];return G}function A$($,Z,Y){var G=0,X=!0;let V=$.length;while(G<V){var K=0;while(G<V&&b($,G)===d)K++,G++;if(G>=V)break;if(K>0)X=!0;let j=b($,G);if(j===t0||j===t1){var U=$Z($,G,{inline:!1},Y);if(U){G=U.endPos,X=!0;continue}}var J=G,Q=0;while(J<V&&Q<4){let v=b($,J);if(v===C)Q++,J++;else if(v===l)Q+=4-Q%4,J++;else break}if(Q<4&&J<V&&b($,J)===g1&&X)if(J+1<V&&b($,J+1)===T9){X=!1;var D=I($,G);G=D>=V?V:k($,D);continue}else{var O=B9($,J,{inline:!1,refs:Z},Y,!1);if(O){G=O.endPos,X=!0;continue}var D=I($,G),A=$.indexOf(":",J+1);if(A===-1||A>=D){var z=t($,G,D);if(!w1($,G,D)&&j!==S9&&j!==C1&&j!==D1&&j!==d1&&z.spaceEquivalent<4)X=!1}G=D>=V?V:k($,D);continue}if(j===C1&&X){var q=G,W=[];while(q<V){var D=I($,q),_=q;while(_<D){let S=b($,_);if(S===C||S===l)_++;else break}if(_>=D||b($,_)!==C1)break;var H=_+1;if(H<D&&(b($,H)===C||b($,H)===l))H++;W.push($.slice(H,D)),q=k($,D)}if(W.length){A$(W.join(`
`),Z,Y),G=q,X=!0;continue}}var D=I($,G);if(D>=V)G=V;else{var F=w1($,G,D),z=t($,G,D);G=k($,D),X=j===S9||j===C1||j===D1||j===d1||F||z.spaceEquivalent>=4}}}function ZZ($,Z){if($.charCodeAt(0)===65279)$=$.slice(1);$=p1($);let G={...{inline:!1,refs:{}}},X={...Z,slugify:Z?.slugify?(K)=>Z.slugify(K,K1):K1,sanitizer:Z?.sanitizer||J9,tagfilter:Z?.tagfilter!==!1};if(!G.inline)A$($,G.refs||{},X);return c9($,G,X)}var G5=/^\n+/,Y5=typeof document<"u";function X5($){let Z=!1;for(let G=0;G<$.length;G++){let X=$.charCodeAt(G);if(X>127||X===k1||X===t0){Z=!0;break}}if(!Z)return $;let Y="";for(let G=0;G<$.length;G++){let X=$.charCodeAt(G);if($[G]==="%"&&G+2<$.length&&/[0-9A-Fa-f]/.test($[G+1])&&/[0-9A-Fa-f]/.test($[G+2]))Y+=$[G]+$[G+1]+$[G+2],G+=2;else if(X===k1)Y+="%5C";else if(X===t0)Y+="%60";else Y+=X>127?encodeURIComponent($[G]):$[G]}return Y}var H1=($)=>Array.isArray($)?$:[$],rZ=($)=>typeof $==="function"||typeof $==="object"&&$!==null&&("render"in $);function sZ($){if(!$)return"";let Z="";for(let[Y,G]of Object.entries($))if(G===!0)Z+=` ${Y}`;else if(G!==void 0&&G!==null&&G!==!1)Z+=` ${Y}="${String(G)}"`;return Z}function J5($,Z,Y,G,X,V,K,U){switch($.type){case M.blockQuote:{let J={},Q=$.children;if($.alert)J.className="markdown-alert-"+V($.alert.toLowerCase(),K1),Q=[{attrs:{},children:[{type:M.text,text:$.alert}],verbatim:!0,type:M.htmlBlock,tag:"header"},...Q];return G("blockquote",J,...H1(Z(Q,Y)))}case M.breakLine:return G("br",{});case M.breakThematic:return G("hr",{});case M.frontmatter:if(U.preserveFrontmatter)return G("pre",{},$.text);return null;case M.codeBlock:{let J=$.lang?M9($.lang):"",Q={...o9($.attrs||{}),className:J?`language-${J} lang-${J}`:""};return G("pre",{},G("code",Q,$.text))}case M.codeInline:return G("code",{},$.text);case M.footnoteReference:return G("a",{href:X($.target,"a","href")},G("sup",{},$.text));case M.gfmTask:return G("input",{checked:$.completed,readOnly:!0,type:"checkbox"});case M.heading:return G(`h${$.level}`,{id:$.id},...H1(Z($.children,Y)));case M.htmlBlock:{let J=$;if(U.tagfilter&&Z$(J.tag)){let Q="rawText"in J&&typeof J.rawText==="string"?J.rawText:`<${J.tag}${sZ(J.attrs)}>`;return G("span",{},Q)}if(J.rawText&&J.verbatim){let q=function(j){if(j.type===M.htmlSelfClosing&&"isClosingTag"in j&&j.isClosingTag)return[];if(j.type===M.paragraph){let v=j.children;return v?v.flatMap(q):[]}if(j.type===M.text)return j.text?.trim()?[j]:[];if(j.type===M.htmlBlock&&j.children)return[{...j,children:j.children?.flatMap(q)}];return[j]},Q=J.tag.toLowerCase(),O=w9(Q),A=/<[a-z][^>]{0,100}>/i.test(J.rawText),z=/<\/?pre\b/i.test(J.rawText);if(O&&!A){let j=J.rawText.replace(new RegExp("\\s*</"+Q+">\\s*$","i"),"");if(U.tagfilter)j=G$(j);return G($.tag,{...$.attrs},j)}if(z){let j=U.tagfilter?G$(J.rawText):J.rawText;return G($.tag,{...$.attrs,innerHTML:j})}if(J.children&&J.children.length>0)return G($.tag,{...$.attrs},Z(J.children.flatMap(q),Y));let W={slugify:(j)=>V(j,K1),sanitizer:X,tagfilter:!0},_=J.rawText.replace(/>\s+</g,"><").replace(/\n+/g," ").trim();if(new RegExp(`^<${J.tag}(\\s[^>]*)?>(\\s*</${J.tag}>)?$`,"i").test(_))return G($.tag,{...$.attrs});let D=c9(_,{inline:!1,refs:K,inHTML:!1},W),F=Z(D.flatMap(q),Y);return G($.tag,{...$.attrs},...H1(F))}return G($.tag,{...$.attrs},...$.children?H1(Z($.children,Y)):[])}case M.htmlSelfClosing:{let J=$;if(U.tagfilter&&Z$(J.tag)){let Q="rawText"in J&&typeof J.rawText==="string"?J.rawText:`<${J.tag}${sZ(J.attrs)} />`;return G("span",{},Q)}return G(J.tag,{...J.attrs})}case M.image:return G("img",{alt:$.alt&&$.alt.length>0?$.alt:void 0,title:$.title||void 0,src:X($.target,"img","src")});case M.link:{let J={};if($.target!=null)J.href=X5($.target);if($.title)J.title=$.title;return G("a",J,...H1(Z($.children,Y)))}case M.table:{let J=$;return G("table",{},G("thead",{},G("tr",{},...J.header.map(function(O,A){return G("th",{style:J.align[A]==null?{}:{textAlign:J.align[A]}},...H1(Z(O,Y)))}))),G("tbody",{},...J.cells.map(function(O,A){return G("tr",{},...O.map(function(q,W){return G("td",{style:J.align[W]==null?{}:{textAlign:J.align[W]}},...H1(Z(q,Y)))}))})))}case M.text:return $.text;case M.textFormatted:return G($.tag,{},...H1(Z($.children,Y)));case M.orderedList:case M.unorderedList:{let J=$.type===M.orderedList?"ol":"ul";return G(J,{start:$.type===M.orderedList?$.start:void 0},...$.items.map(function(O,A){return G("li",{},...H1(Z(O,Y)))}))}case M.paragraph:return G("p",{},...H1(Z($.children,Y)));case M.ref:return null;default:return null}}var K5=($,Z,Y,G,X,V)=>{let K=(Q,O,A)=>{let z=()=>J5(Q,(q)=>O(H1(q)),A,Z,Y,G,X,V);return $?$(z,Q,O,A):z()},U=(Q)=>Q.map((O)=>("text"in O)?O.text:""),J=(Q,O={})=>{let A=(O.renderDepth||0)+1;if(A>2500)return U(Q);let z=[],q=!1;for(let W=0;W<Q.length;W++){let _=K(Q[W],J,{...O,renderDepth:A}),H=typeof _==="string";if(H&&q)z[z.length-1]+=_;else if(_!==null)if(Array.isArray(_))for(let D=0;D<_.length;D++)z.push(_[D]);else z.push(_);q=H}return z};return J},V5=(...$)=>$.filter(Boolean).join(" "),U5=($,Z)=>{let Y=U9(Z,$,void 0);if(!Y)return $;if(rZ(Y))return Y;let G=U9(Z,`${$}.component`,$);return rZ(G)?G:G};function nZ($,Z){let Y={...Z||{}};Y.overrides=Y.overrides||{};let G=Y.slugify||K1,X=Y.sanitizer||J9,V=(F)=>Q5(F,{...Y,wrapper:null});function K(F,j,...v){if(!Y5){let w=v.length===0?void 0:v.length===1?v[0]:v,E=w===void 0?j:{...j,children:w};if(typeof F==="function")return F(E);return{t:F,p:E}}let S=oZ(F,j,...v);return typeof S==="function"?S():S}function U(F,j,...v){let S=U9(Y.overrides,`${F}.props`,{}),w=o9(j||{});for(let y in w){let B=w[y];if(typeof B==="string"&&B.length>0&&B[0]==="<"&&(fZ.test(B)||gZ.test(B)||o1(B,0)))w[y]=V(B.trim())}let E=U5(F,Y.overrides),T=V5(w?.className,S.className||void 0)||void 0,N={...w,...S};if(T)N.className=T;if(w.innerHTML&&S.innerHTML===void 0)N.innerHTML=w.innerHTML,delete w.innerHTML;return K(E,N,...v)}let J=Y.createElement||((F,j,...v)=>K(F,j||{},...v));function Q(F){let j="";for(let v of F){let S=v.type;if(S===M.text)j+=v.text;else if(S===M.htmlSelfClosing&&"rawText"in v){let w=v.rawText;if(w)j+=w}else if(S===M.textFormatted){let w=v,E=w.tag==="em"?"_":w.tag==="strong"?"**":"";j+=E+Q(w.children)+E}else if("children"in v&&v.children)j+=Q(v.children)}return j}let O=[];for(let F=0;F<$.length;F++){let j=$[F];if(j.type===M.htmlBlock&&"rawText"in j&&j.rawText&&/<\/?pre\b/i.test(j.rawText)&&F+1<$.length&&$[F+1].type===M.paragraph&&"removedClosingTags"in $[F+1]&&$[F+1].removedClosingTags){let v=j,S=$[F+1],w=Q(S.children);if(S.removedClosingTags){let N=[],y=`</${v.tag}>`;for(let B of S.removedClosingTags)if(B.type===M.htmlSelfClosing&&"rawText"in B){let R=B.rawText;if(R&&R.indexOf(y)===-1)N.push(R)}w+=N.join("")}let E=(v.rawText||"")+`
`+w,T={...v,rawText:E,text:E};O.push(T),F++}else O.push(j)}let A={slugify:(F)=>G(F,K1),sanitizer:X,tagfilter:Y.tagfilter!==!1,disableAutoLink:Y.disableAutoLink,disableParsingRawHTML:Y.disableParsingRawHTML,enforceAtxHeadings:Y.enforceAtxHeadings,forceBlock:Y.forceBlock,forceInline:Y.forceInline,preserveFrontmatter:Y.preserveFrontmatter},z=O[0]&&O[0].type===M.refCollection?O[0].refs:{},q=K5(Y.renderRule,U,X,G,z,Y),W=q(O,{inline:Y.forceInline,refs:z}),_=[];for(let F in z)if(F.charCodeAt(0)===T9)_.push({identifier:F,footnote:z[F].target});if(_.length)W.push(U("footer",{},..._.map(function(j){let v=j.identifier.slice(1),S=c9(j.footnote,{inline:!0,refs:z},A),w=q(S,{inline:!0,refs:z});return U("div",{id:G(v,K1)},v+": ",...H1(w))})));if(Y.wrapper===null)return W.length===0?null:W.length===1?W[0]:W;let H=Y.wrapper||(Y.forceInline?"span":"div"),D;if(W.length>1||Y.forceWrapper)D=W;else if(W.length===1)return W[0];else return null;return J(H,{...Y.wrapperProps},D)}function Q5($="",Z={}){let Y={...Z||{}};Y.overrides=Y.overrides||{};let G=Y.slugify||K1,X=Y.sanitizer||J9;function V(J){let Q=Y.forceInline||!Y.forceBlock&&!S$.test(J),O={slugify:(q)=>G(q,K1),sanitizer:X,tagfilter:Y.tagfilter!==!1,disableAutoLink:Y.disableAutoLink,disableParsingRawHTML:Y.disableParsingRawHTML,enforceAtxHeadings:Y.enforceAtxHeadings,forceBlock:Y.forceBlock,forceInline:Q,preserveFrontmatter:Y.preserveFrontmatter};if(!Q)A$(J,K,O);let A=J;if(!Q){let q=A.length;while(q>0&&(A[q-1]===`
`||A[q-1]==="\r"))q--;A=A.slice(0,q),A=`${A.replace(G5,"")}

`}let z=c9(Q?J:A,{inline:Q,refs:K},O);return nZ(z,{...Y,forceInline:Q})}let K={};return V($)}var tZ=$5(void 0);function z5($,Z,...Y){if(typeof document>"u"){let X=Y.length===0?void 0:Y.length===1?Y[0]:Y,V=X===void 0?Z:{...Z,children:X};if(typeof $==="function")return $(V);return{t:$,p:V}}let G=oZ($,Z,...Y);return typeof G==="function"?G():G}var S5=($)=>{let Z={value:$.options};return z5(tZ.Provider,Z,$.children)},_5=($)=>{let Z=Z5(tZ),Y=w$(()=>({...Z,...$.options})),G=w$(()=>{let K=typeof $.children==="function"?$.children():$.children;return K===null||K===void 0?"":K}),X=w$(()=>ZZ(G(),Y()));return w$(()=>nZ(X(),{...Y(),wrapperProps:{...Y()?.wrapperProps,...Object.fromEntries(Object.entries($).filter(([K])=>K!=="children"&&K!=="options"))}}))()},f5=_5;export{K1 as slugify,J9 as sanitizer,ZZ as parser,f5 as default,Q5 as compiler,nZ as astToJSX,M as RuleType,S5 as MarkdownProvider,tZ as MarkdownContext,_5 as Markdown};

//# debugId=56EC382212363E0F64756E2164756E21
